...
public class Solution {
        ...
        Collections.sort(list, new Comparator<Stock>() {
            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (stock1.containsKey("open")){
                    prib1 = (double)stock1.get("last")-(double)stock1.get("open");
                }else {
                   // prib1 = 0d;
                    prib1 = (double)stock1.get("change");
                }
                Double prib2;
                if (stock2.containsKey("open")){
                    prib2 = (double)stock2.get("last")-(double)stock2.get("open");
                }else {
                    //prib2 = 0d;
                    prib2 = (double)stock2.get("change");
                }
                return prib2.compareTo(prib1);
            }
        }));
    }
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Cisco Systems, Inc.", "CSCO", 25.84, 36.3));
